...
const $url ='http://openapi.airkorea.or.kr/openapi/services/rest/ArpltnInforInqireSvc/getCtprvnMesureLIst?itemCode=PM10&dataGubun=DAILY&searchCondition=MONTH&pageNo=1&numOfRows=10&ServiceKey=vdV%2B8EeWPgBthUe3Y9mji7ct6VbJO7y8ShTDPLDoQKis7tw%2BIofWzd4tAQHHEADRnLTFW3a0HCDYopMs3ZRLvg%3D%3D';
...
request($url,function(err,res,body){
    ...
    var file = fs.createWriteStream('dust10data.js');
    file.on('error', function(err) { Console.log(err) });
    file.write('var dust10=[');
    file.write(`${jeju},\n`)
